...
@Component({
  ...
  styleUrls: ['./styles/parametres.page.scss'],
})
  ...
  validations = {
    ...
    phone: [
      { type: 'required', message: 'Phone is required.' },
      {
        ...
        message: 'Phone is incorrect for the selected country.',
      },
    ],
    password: [
    ...
    guests: [{ type: 'rangeError', message: 'Number must be between: ' }],
    bedrooms: [{ type: 'rangeError', message: 'Number must be between: ' }],
    terms: [
