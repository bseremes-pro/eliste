...
export class SeoService implements OnDestroy {
    ...
    this._routerSubscription = this.router.events
      ...
      .subscribe((event) => {
        ...
        if (routeData && routeData.seo) {
          ...
          currentRouteSeoData.title =
            'Elistes - Communauté de partage de listes';
          currentRouteSeoData.description =
            'Elistes - Communauté de partage de listes';
          currentRouteSeoData.keywords = 'partage, liste';
          currentRouteSeoData.image =
            'assets/sample-images/elistes-app-icone.png';
  ...
  setSeoMetaTags(seoData: SeoDataModel) {
    ...
    this.meta.updateTag(
      { name: 'DC.title', content: seoData.title },
      'name="DC.title"'
    );
    this.meta.updateTag(
      { name: 'DC.description', content: seoData.description },
      'name="DC.description"'
    );
